...
import com.ahmedkenawy.instagram.Model.Notification;
...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ImageViewHolder> {
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageViewHolder(View itemView) {
            ...
            image_profile = itemView.findViewById(R.id.image_profileNotification);
            post_image = itemView.findViewById(R.id.post_imageNotification);
            username = itemView.findViewById(R.id.usernameNotification);
            text = itemView.findViewById(R.id.commentNotification);
        }
    }
